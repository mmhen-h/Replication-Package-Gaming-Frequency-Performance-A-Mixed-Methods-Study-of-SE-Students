...
- **LLM Outputs:** The raw CSV outputs (e.g. ```FA22_Exhaustive_Coded.csv```) generated by Gemini 3 Pro and the post‑audit CSVs (e.g. ```AUDITEDFA22_Exhaustive_Coded.csv```) following the 25\% random sample manual verification.
